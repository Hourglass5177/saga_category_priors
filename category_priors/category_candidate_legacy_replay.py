...
"""Unprotected replay of repaired candidates through the legacy denoiser.

This module starts from the exact ``global_pre_knn`` partition and a frozen
candidate pool.  Uniform and class-prior conditions pass different accepted
candidate IDs but otherwise execute the same path:

# SAGA 类别先验与小物体保护实验计划（当前权威：固定候选的小簇删除最终验证）

> **权威状态：第 24 至 26 节的提示式尺度路线已经闭环并停止。用户于
> 2026-08-28 授权第 27 节“固定候选的小簇删除最终验证”，这是当前唯一执行路径。
> V10B 身份头与任何新 ObjectBank 均未获授权。** 旧 B2、class-first、
...
- 当前状态：**PMR-3 已完成且停止尺度门控路线；正在执行第 27 节固定候选的小簇删除最终验证**
...
- [ ] 实现CPU replayer、评价器和回归测试。
- [ ] 运行两场机械/能力检验，并按门槛停止或进入六场确认。
- [ ] 形成面向老师的失败结论与因果证据文档。

...
class GaussianSplattingGUI:
    ...
    def fetch_data(self, view_camera):
        ...
        if self.render_mode_cluster:
            ...
            render_num += 1
        if self.render_mode_label and self.point_labels is not None:
...
if __name__ == "__main__":
    ...
    feat_gs_model = FeatureGaussianModel(opt.feature_dim, opt.semantic_feature_dim)
